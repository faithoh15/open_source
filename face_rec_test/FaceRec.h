...
void detectAndDisplay(Mat frame)
{
...

	{
		...
		stringstream ssfn;
		filename = "C:\\Users\\Hyunji\\AppData\\Local\\Programs\\Python\\Python38\\Faces\\";
...
void addFace()
{
	...
	if (!face_cascade.load("C:\\opencv\\build\\install\\etc\\haarcascades\\haarcascade_frontalface_alt.xml"))
	{
		cout << "error" << endl;
		return;
	};
...
static void dbread(vector<Mat>& images, vector<int>& labels) {
	vector<cv::String> fn;
	filename = "C:\\Users\\Hyunji\\Desktop\\Faces\\";
	glob(filename, fn, false);

	//glob("C:\\Users\\Hyunji\\Desktop\\Faces\\Ali\\*.jpg", fn, false);
...
void eigenFaceTrainer() {
	...
	model->save("C:\\Users\\Hyunji\\Desktop\\eigenface.yml");
...
void  FaceRecognition() {
	...
	Ptr<FisherFaceRecognizer> model = cv::face::FisherFaceRecognizer::create();
	model->read("C:\\Users\\Hyunji\\Desktop\\eigenface.yml");

	Mat testSample = imread("C:\\Users\\Hyunji\\Desktop\\0.jpg", 0);
